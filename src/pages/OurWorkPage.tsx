              ...
              <ScrollReveal key={project.slug} delay={index * 0.05}>
                ...
                >
                  ...
                  <div className="photo-overlay absolute bottom-0 left-0 right-0 p-5">
                    <p className="text-white/80 text-xs uppercase tracking-wide mb-1 drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]">
                      {project.client}
                    </p>
                    <h3 className="text-white font-display text-base leading-snug drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]">
                      {project.title}
                    </h3>
                    <div className="flex items-center gap-2 text-white text-sm mt-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-1 group-hover:translate-y-0 drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]">
